...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">DataTable UKM</h3>
    </div>
    <div class="card-body">

        <a href="<?php echo e(route('ukm.create')); ?>"><button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</button></a>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                <?php $__currentLoopData = $ukm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($data->nama); ?></td>
                    <td><img src="<?php echo e(Storage::url('ukm/'.$data->foto)); ?>" style="width:150px" class="img-thumbnail">

                    </td>
                    <td><?php echo e($data->Deskripsi); ?></td>
                    <td>
                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('ukm.destroy', $data->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" class="btn btn-outline-danger"><i class="fa fa-trash"></i></button>
                        </form>
                        &nbsp;
                        <a href="<?php echo e(route('ukm.edit', $data->id)); ?>" class="btn btn-outline-warning"><i class="fa fa-edit"></i></a>
                    </td>
                </tr>
...
<?php echo $__env->make('template/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Kuliah\Framework\laravel_iqbal\resources\views/ukm/index.blade.php ENDPATH**/ ?>